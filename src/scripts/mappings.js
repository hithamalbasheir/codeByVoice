...
module.exports.spell = function(shit){
  return `${shit}`
}
...
module.exports.shiftRight = function(){
  return `shift right`; 
}
module.exports.shiftLeft = function(){
  return `shift left`; 
}
module.exports.stepUp = function() {
  return `step up`;
}
module.exports.stepDown = function() {
  return `step down`;
}
module.exports.stepRight = function() {
  return `step right`;
}
module.exports.stepLeft = function() {
  return `step left`;
}
...
module.exports.switchFile = function() {
  return `control tab`
}
module.exports.saveas = function() {
  return `saving`
}
module.exports.backspace = function(){
  return `backspace`
}
...
module.exports.switchApp = function(){
  return`alt tab`
}
module.exports.html = function(){
  return `
    <html>
      <! -- write wtvr U want in here-->
    </html>
  `
}
